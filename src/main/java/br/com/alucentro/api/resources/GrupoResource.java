...
public class GrupoResource {
	...
	@PostMapping
	public ResponseEntity<Grupo> Salvar(@Valid @RequestBody Grupo grupo, HttpServletResponse resposta){
		Grupo salvo = this.service.Criar(grupo);
